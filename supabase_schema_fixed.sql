-- Fixed WeBond Database Schema for Supabase
-- This version works with Supabase Auth (no password_hash field)
...
-- Users Table (Fixed for Supabase Auth)
...
-- Tasks Table (Fixed category values)
CREATE TABLE IF NOT EXISTS tasks (
    ...
    category VARCHAR(100) NOT NULL CHECK (category IN ('administrative', 'daily_life', 'translation', 'visa_help', 'navigation', 'shopping', 'admin_help', 'other')),
